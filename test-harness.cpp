...
/*
  ...
  r_tree.insert(r3, "key5");r_tree.insert(r, "keeeey16");
  r_tree.insert(r3, "key6");r_tree.insert(r, "keeeey17");
  r_tree.insert(r3, "key7");r_tree.insert(r, "keeeey18");
  r_tree.insert(r3, "key8");r_tree.insert(r, "keeeey19");
  r_tree.insert(r3, "key9");r_tree.insert(r, "keeeey20");
  r_tree.insert(r3, "key11");
  */
  r_tree.printarbol(r_tree.root_pointer_,0);
